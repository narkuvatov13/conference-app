            ...
            <div class="pd-ltr-20 xs-pd-20-10">
                <div class="min-height-200px">
                    ...
                    <div class="pd-20 card-box mb-30">
                        ...
                        <form action="{{route('hakem.update',$user->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('patch')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input class="form-control" name="universite" value="{{$user->universitesi}}" type="text" placeholder="...">
                                </div>
                            </div>
                            <div class="form-group row">
