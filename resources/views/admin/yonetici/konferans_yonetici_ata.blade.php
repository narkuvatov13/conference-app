                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <nav aria-label="breadcrumb" role="navigation">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Konferanslara Yönetici Ata</li>
                        ...
                        <div class="pb-20">
                            <table class="data-table table stripe hover">
                                ...
                                @foreach($konferanslar as $konferans)
                                            <tr>
                                                <form action="{{route('yoneticiKonferansaAta.update',$konferans->id)}}" method="post">
                                                    @csrf
                                                    @method('patch')
                                                     ...
                                                     @if($konferans->user->atandiMi == 1)
                                                            <div class="col-sm-12 col-md-10">
                                                                <select name="user_id" class="custom-select col-12" id="yoneticiler">
                                                                    <option  value="{{$konferans->user->id}}">{{$konferans->user->name}}</option>
                                                                </select>
                                                            </div>
                                                     @endif
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                            ...
                                                            @endif
                                                            @if($konferans->user->atandiMi == 1)
                                                                    <a href="{{route('yoneticiKonferansaAta.destroy',$konferans->user->id)}}" class="dropdown-item">
